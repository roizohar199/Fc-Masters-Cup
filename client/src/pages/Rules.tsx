        ...
        <div style={{ direction: "rtl", lineHeight: 1.8 }}>
          ...
          <section style={{ marginBottom: 40 }}>
            ...
            <ul style={{ fontSize: 16, color: "#333", paddingRight: 20 }}>
              ...
              <li style={{ marginBottom: 12 }}>
                <strong style={{ color: "#e65100" }}>חובה להעלות תמונה של תוצאת המשחק</strong> כהוכחה לתוצאה.
              </li>
              <li style={{ marginBottom: 12 }}>
                התמונה חייבת להיות <strong>ברורה וקריאה</strong>, ולהראות את התוצאה הסופית בבירור.
              </li>
              <li style={{ marginBottom: 12 }}>
                פורמטים מקובלים: JPG, PNG, WEBP. גודל מקסימלי: 10MB.
              </li>
              <li style={{ marginBottom: 12 }}>
                <strong style={{ color: "#c62828" }}>שחקן שלא יעלה תמונה יודח מהטורניר ללא החזר כספי!</strong>
              </li>
              <li style={{ marginBottom: 12 }}>
                במקרה של אי התאמה בתוצאות, הנהלת הטורניר תבדק את התמונה ותכריע.
              </li>
            </ul>
          </section>
